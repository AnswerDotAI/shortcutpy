...
MANUAL_ACTIONS = {"ask_for_datetime", "ask_for_text", "choose_from_menu", "get_files", "preferred_language", "raw_action",
    "resize_image", "save_file", "shortcut", "shortcut_input", "show_result", "unix_timestamp"}
